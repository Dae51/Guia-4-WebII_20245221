...
export const ExpenseForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const totalExpenses = state.expenses.reduce((total, currentExpense) => total + currentExpense.amount, 0)
    const editingExpense = state.expenses.find(currentExpense => currentExpense.id === state.editingId)
    const editingAmount = editingExpense ? editingExpense.amount : 0
    const availableBudget = state.editingId ? state.budget - (totalExpenses - editingAmount) : state.budget - totalExpenses
